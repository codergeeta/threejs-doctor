...
CLI/runtime for static scan is **`npx threejs-doctor@0.1.5`** (already on npm). The live-attach IIFE is still this repo file — it is not published. Scan/ci is **not** a substitute for this phone capture.
